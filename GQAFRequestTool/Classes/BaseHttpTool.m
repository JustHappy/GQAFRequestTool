...
//
//+ (void)get:(NSString *)url params:(NSDictionary *)params success:(void (^)(id))success failure:(void (^)(NSError *))failure With:(UIViewController *)VC
//{
...
//
//
//+ (void)post:(NSString *)url params:(NSDictionary *)params success:(void (^)(id))success failure:(void (^)(NSError *))failure With:(UIViewController *)VC
//{
//    [UIApplication sharedApplication].networkActivityIndicatorVisible = YES;
//    AFHTTPSessionManager *mgr = [AFHTTPSessionManager manager];
...
//}
//
//+(void)postWithData:(NSString *)url params:(NSDictionary *)params data:(NSData *)data fileName:(NSString *)fileName mimeType:(NSString *)mimeType success:(void (^)(id))success failure:(void (^)(NSError *))failure With:(UIViewController *)VC{
//    AFHTTPSessionManager *mgr = [AFHTTPSessionManager manager];
...
//}
//
//+(void)postWithFilePath:(NSString *)url params:(NSDictionary *)params dataFilePath:(NSString *)filePath fileName:(NSString *)fileName mimeType:(NSString *)mimeType success:(void (^)(id))success failure:(void (^)(NSError *))failure With:(UIViewController *)VC{
//    AFHTTPSessionManager *mgr = [AFHTTPSessionManager manager];
//    mgr.requestSerializer.timeoutInterval = 20;
//    mgr.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"text/plain", @"multipart/form-data", @"application/json", @"text/html", @"image/jpeg", @"image/png", @"application/octet-stream", @"text/json", nil];
//    
